...
public class GummyMaskModel {
	...
	public GummyMaskModel(ModelPart root) {
	...
	public static ModelData getModelData() {
		...
		.uv(0, 43).cuboid(-2.0F, -14.0F, -2.0F, 4.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(16, 43).cuboid(-2.0F, -14.75F, -2.0F, 4.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(29, 40).cuboid(-1.5F, -15.25F, -1.5F, 3.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
