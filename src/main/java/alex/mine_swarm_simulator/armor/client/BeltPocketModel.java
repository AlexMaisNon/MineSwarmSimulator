...
public class BeltPocketModel {
	...
	public BeltPocketModel(ModelPart root) {
	...
	public static ModelData getModelData() {
		...
		ModelPartData body = modelPartData.addChild("body", ModelPartBuilder.create().uv(0, 11).cuboid(-2.0F, 10.0F, -3.875F, 4.0F, 2.0F, 3.0F, new Dilation(0.0F))
		.uv(0, 6).cuboid(-2.5F, 8.25F, -4.375F, 5.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(0, 0).cuboid(-2.5F, 8.75F, -4.375F, 5.0F, 2.0F, 4.0F, new Dilation(0.0F))
		.uv(0, 16).cuboid(-1.5F, 10.0F, -4.625F, 3.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
