...
public class ModItems{
	...
	public static final Item ATOMIC_TREAT = registerItem("atomic_treat", new Item(new Item.Settings()));
	public static final Item BASIC_EGG = registerItem("basic_egg", new Item(new Item.Settings()));
	public static final Item BITTERBERRY = registerItem("bitterberry", new Item(new Item.Settings()));
	...
	public static final Item GINGERBREAD_BEAR = registerItem("gingerbread_bear", new Item(new Item.Settings()));
	...
	public static final Item MOON_CHARM = registerItem("moon_charm", new Item(new Item.Settings()));
	...
	public static final Item NEONBERRY = registerItem("neonberry", new Item(new Item.Settings()));
	...
	public static final Item STAR_TREAT = registerItem("star_treat", new Item(new Item.Settings()));
