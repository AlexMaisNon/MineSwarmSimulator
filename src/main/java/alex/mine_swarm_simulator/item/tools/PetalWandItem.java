...
public class PetalWandItem extends CollectToolItem {
	public PetalWandItem() {
		super(3, 0.7f, 6, new BlockPos[]{
			new BlockPos(0, 0, -5),
			new BlockPos(-1, 0, -4), new BlockPos(0, 0, -4), new BlockPos(1, 0, -4),
			new BlockPos(-1, 0, -3), new BlockPos(0, 0, -3), new BlockPos(1, 0, -3),
			new BlockPos(0, 0, -2),
			new BlockPos(-4, 0, -1), new BlockPos(-3, 0, -1), new BlockPos(0, 0, -1), new BlockPos(3, 0, -1), new BlockPos(4, 0, -1),
			...
			new BlockPos(-1, 0, 4), new BlockPos(0, 0, 4), new BlockPos(1, 0, 4),
			new BlockPos(0, 0, 5)
		}, false, "item.mine_swarm_simulator.petal_wand.desc");
	}
