...
public class HiveSlotBlockEntityRenderer implements BlockEntityRenderer<HiveSlotBlockEntity> {
	...
	public HiveSlotBlockEntityRenderer(BlockEntityRendererFactory.Context context) {}

	@Override
	public void render(HiveSlotBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
		...
		if(entity.getBeeLevel() > 1) {
			...
			String text = !entity.getBeeUUID().equals(HiveSlotBlockEntity.defaultUUID) ? String.valueOf(entity.getBeeLevel()) : "";
